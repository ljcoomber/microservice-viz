...
//    export interface MutableLayout {
//        cy;
//        addService(id:string, url?:string, vlan?:string, parent?:string): void;
//        addConnection(id:string, source:string, target:string): void;
//        changeServiceStatus(id:string, status:Status): void;
//        changeConnectionStatus(id:string, status:Status): void;
//    }
...
//            }
//
//            addVlan(id:string):void {
//                this.addIfNotExists(id, {group: 'nodes', data: {id: id}}, false);
//            }
//
//            addService(id:string, url:string = '', vlan:string = 'external', parent:string = null):void {
//                var exists = this.cy.$('#' + id).length > 0;
//                if (!exists) {
//                    this.addVlan(vlan);
//
//                    var actualParent = parent ? parent : vlan;
//
//                    var width = id.length * 9   // Very crude width calculation
//                    this.cy.add({
//                        group: "nodes",
//                        css: {width: width},
//                        data: {id: id, parent: actualParent},
//                        position: {x: 100, y: 100}
//                    });
//
//                    this.cy.elements().layout(LAYOUT);
//                }
//            }
//
//            addConnection(id:string, source:string, target:string):void {
